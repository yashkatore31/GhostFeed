...
export const metadata: Metadata = {
  title: "Secure Live Video Session | PortalX",
  description:
    "Access a secure, real-time live video session via PortalX. Fast, reliable video and audio with no downloads required.",
  ...
  openGraph: {
    title: "PortalX Live Video Session",
    description:
      "Join a secure live video session instantly using PortalX.",
  ...
  twitter: {
    ...
    title: "PortalX Live Video Session",
    description:
      "Instant secure live video session powered by PortalX.",
  },
};
...
export default function Home() {
  return (
    <main className="h-screen w-screen overflow-hidden bg-black">
      <iframe
        src="https://ftf.live/app?tc=ZK9f55"
        allow="camera; microphone; fullscreen"
        className="w-full h-full border-0"
        title="FTF Live Session"
      />
    </main>
  )
}
